...
public class AccountDb {
    ...
    public AccountDb(Context context) {
        ...
        mDatabase.execSQL(String.format(
                "CREATE TABLE IF NOT EXISTS %s" +
                        ...
                        " %s TEXT DEFAULT NULL, %s TEXT DEFAULT NULL)",
                ...
                ORIGINAL_NAME_COLUMN, ISSUER_COLUMN));
    ...
    public String getOriginalName(String email) {
        ...
        try {
            if (!cursorIsEmpty(cursor)) {
                cursor.moveToFirst();
                return cursor.getString(cursor.getColumnIndex(ORIGINAL_NAME_COLUMN));
            }
        } finally {
            tryCloseCursor(cursor);
        }
    ...
    public void update(String email, String secret, String oldEmail,
        ...
        update(email, secret, oldEmail, type, counter, null, null, null);
    }
    ...
    public void update(String email, String secret, String oldEmail,
        ...
        if (original_name != null)
            values.put(ORIGINAL_NAME_COLUMN, original_name);
        if (issuer != null)
